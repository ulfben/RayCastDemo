...
namespace Cfg {	
	...
	static constexpr auto MAP_SCALE_FACTOR = 3; //how many left shifts to perform (eg. 8 times smaller than the actual world)
...
static constexpr auto ANGLE_360 = Cfg::TABLE_SIZE; //number of possible angles in a full rotation (also, direction: right)        
